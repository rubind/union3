...
python step1_make_simLCs.py --ndataset 20 --addnoise 1 --addcalibration 0 --modeluncertainty 1 --prefixname /home/drubin/koa_scratch/sim_data_simplex_vollim --skewdist 1 --volumelimited 1 --obsmagselection 1 --zrangekeys H --sigzp 0.0001 --ncalibperset 0 --nvisit 600  > log.txt
