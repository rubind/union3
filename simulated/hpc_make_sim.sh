...
python step1_make_simLCs.py --ndataset 80 --addnoise 1 --addcalibration 1 --modeluncertainty 1 --prefixname /home/drubin/koa_scratch/sim_data_simplex --skewdist 1 --volumelimited 0 --obsmagselection 1 > log.txt
