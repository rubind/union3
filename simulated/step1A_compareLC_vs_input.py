...
for resfl in glob.glob("dataset_000/*/res*salt2.dat"):
    ...
    if obs_c != None:
        ...
        all_dat["obs_sigc"].append(obs_sigc)
        ...
        all_dat["obs_sigx1"].append(obs_sigx1)
...
all_dat["pulls_c"] = all_dat["delta_c"]/all_dat["obs_sigc"]
all_dat["pulls_x1"] = all_dat["delta_x1"]/all_dat["obs_sigx1"]
