...
[weight, minuslogpost, cosmomc_theta, ombh2, omch2, tau, ns, logA, w, wa] = readcol(sys.argv[1], 'i,f,f,ff,f,f,f,ff')
...
print("chi2 of -1 0 ", sys.argv[1], chi2_LCDM, " sigma: ", twoD_chi2_to_sigma(chi2_LCDM))
