...
def init_fn():
    ...
    return {"MB": random.random(size = [(n_samples - 1)*stan_data["MB_by_sample"] + 1])*0.2 - 19.1,
            ...
            "alpha_angle": arctan(random.random()*0.1 + 0.1),
            "alpha_angle_fast": arctan(random.random()*0.1 + 0.1),
            "alpha_angle_slow": arctan(random.random()*0.1 + 0.1),
            "beta_angle_blue": arctan(random.random()*0.5 + 2.0),
            "beta_angle_blue_fast": arctan(random.random()*0.5 + 2.0),
            "beta_angle_blue_slow": arctan(random.random()*0.5 + 2.0),
            "beta_angle_red_low": arctan(random.random()*0.5 + 3.0),
            "beta_angle_red_high": arctan(random.random()*0.5 + 3.0),
            "beta_angle_red_fast": arctan(random.random()*0.5 + 3.0),
            "beta_angle_red_slow": arctan(random.random()*0.5 + 3.0),
